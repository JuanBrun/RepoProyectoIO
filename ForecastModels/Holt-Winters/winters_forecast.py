...
if n_periods < 24:
    ...
    seasonal_periods = 12
    print(f"  ✓ Usando ciclo estacional de {seasonal_periods} meses")
...
try:
    ...
    # Guardar gráfico
    output_path = os.path.join(script_dir, 'winters_forecast.png')
    ...
    # Exportar a CSV
    results_path = os.path.join(script_dir, 'winters_results.csv')
    results_df.to_csv(results_path, index=False)
    
    forecast_path = os.path.join(script_dir, 'winters_forecast.csv')

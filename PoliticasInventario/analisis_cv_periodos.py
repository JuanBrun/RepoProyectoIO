...
print(f"  Estado: {'✓ EOQ válido' if cv_total < 0.20 else '✗ CV alto, EOQ no recomendado'}")
...
if ventanas_validas:
    ...
    print("  Se recomienda usar Silver-Meal o Wagner-Whitin")
...
print(f"""
  ...
  3. Estrategia recomendada según Winston:
     ...
     → Usar métodos de demanda variable (Silver-Meal, Wagner-Whitin)
